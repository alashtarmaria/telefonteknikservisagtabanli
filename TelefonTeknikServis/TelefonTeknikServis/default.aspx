<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="TelefonTeknikServis._default" %>
                ...
                <div class="row center">
                    ...
                    <div class="col-sm-12">
                        <p class="v-smash-text-large-2x">
                            Anasayfa Yazısı</p>
                        <p class="v-smash-text-large-2x">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EmptyDataText="Görüntülenecek hiç veri kaydı yok." Height="201px" Width="1049px">
                                <Columns>
                                    <asp:BoundField DataField="anasayfa" HeaderText="anasayfa" SortExpression="anasayfa" />
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:telefon_teknik_servisConnectionString1 %>" ProviderName="<%$ ConnectionStrings:telefon_teknik_servisConnectionString1.ProviderName %>" SelectCommand="SELECT [anasayfa] FROM [sayfalar]"></asp:SqlDataSource>
                        </p>
