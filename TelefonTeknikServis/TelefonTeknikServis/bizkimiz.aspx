<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bizkimiz.aspx.cs" Inherits="TelefonTeknikServis.bizkimiz" %>
                ...
                <div class="row center">
                    ...
                    <div class="col-sm-12">
                        <p class="v-smash-text-large-2x">
                            Biz Kimiz Yazısı</p>
                        <p class="v-smash-text-large-2x">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" EmptyDataText="Görüntülenecek hiç veri kaydı yok." Width="938px">
                                <Columns>
